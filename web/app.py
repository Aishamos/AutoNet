...
# 强制切换工作目录到项目根目录
# 这一步非常关键，确保底层 Ansible 脚本能正确找到 inventory.yml 和 vault_pass.txt
os.chdir(PROJECT_ROOT) 

# ========== 注册 API 蓝图 ==========
# 将后端的 5 大模块 API 全部挂载到主程序上
...
# 我们将 socketio 实例传入，这样后台脚本发现状态变化时可以直接 emit 推送
...
if __name__ == '__main__':
    ...
    # 必须使用 socketio.run 代替原有的 app.run
